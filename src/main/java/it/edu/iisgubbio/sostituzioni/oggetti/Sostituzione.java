...
public class Sostituzione extends OraLezione {
	...
	public enum Motivo {
		...
		libero_della_classe, libero_altra_classe_stesso_gruppo, libero_altra_classe_altro_gruppo, ora_buca_della_classe, ora_buca_altra_classe_stesso_gruppo, ora_buca_altra_classe_altro_gruppo, indefinito
	}
